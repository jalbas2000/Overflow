    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3 p-6 shadow-xl bg-white dark:bg-black'>
            ...
            <div className='flex flex-col gap-3 w-full'>
                ...
                <p className='text-sm'>Add upto 5 tags to describe what your question is about</p>
                {tags.length > 0 && (
                    <Controller
                        name='tags'
                        control={control}
            ...
            <Button isLoading={isSubmitting || pending} isDisabled={!isValid || pending} type='submit' color='primary' className='w-fit'>
